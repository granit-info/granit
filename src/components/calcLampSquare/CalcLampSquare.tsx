...
import css from "./CalcLampSquare.module.css";
...
export default function CalcLampSquare() {
  const koefLampSquare = 1.2;
  ...
  const [quantity, setQuantity] = useSyncedState<number>("LampSquareQuantity", 1);
  ...
  return (
    <>
      <div className={css.container}>
          ...
          <div className={css.rightSide}>
            ...
            isValidForm ? (
              <div className={css.textResult}>
                ...
                <br />
                <p>Враховано коефіцієнт: x{koefLampSquare}</p>
        ...
        <div className={css.sheet}>
          <div className={css.leftSide}>
            <p>Вкажіть кількість квадратних лампадок:</p>
            <TextField
              id="quantity"
              label="Кількість"
              variant="standard"
        ...
        <div>
          <Accordion style={{ marginBottom: "10px" }}>
            <AccordionSummary
              ...
              id="panel1-header"
            >
              Загальна вартість квадратних лампадок:{" "}
            ...
            <AccordionDetails>
              {costMaterial && isValidForm ? (
                <div>
                  <p className={css.textCost}>
                    Матеріал для однієї квадратної лампадки: {" "}
                    {Number(costMaterial.toFixed(2)).toLocaleString("ru-RU")}{" "}
                    грн.
                  </p>
                  <p>Кількість квадратних лампадок: {quantity} шт.</p>
                </div>
              ) : (
                <p> </p>
              )}

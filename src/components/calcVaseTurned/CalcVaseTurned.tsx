...
import css from "./CalcVaseTurned.module.css";
...
export default function CalcVaseTurned() {

  const koefVaseTurned = 1.1;
  ...
  const [quantity, setQuantity] = useSyncedState<number>("vaseTurnedQuantity", 1);
          ...
          <div className={css.rightSide}>
            ...
            isValidForm ? (
              <div className={css.textResult}>
                ...
                <br />
                <p>Враховано коефіцієнт: x{koefVaseTurned}</p>
          ...
          <Accordion style={{ marginBottom: "10px" }}>
            ...
            <AccordionDetails>
              {costMaterial && isValidForm ? (
                <div>
                  <p className={css.textCost}>
                    Матеріал для однієї точеної вази: {" "}

...
import css from "./CalcVaseSquare.module.css";
...
export default function CalcVaseSquare() {

  const koefVaseSquare = 1.1;
  ...
  const [quantity, setQuantity] = useSyncedState<number>("vaseSquareQuantity", 1);
  ...
  return (
    <>
      <div className={css.container}>
          ...
          <div className={css.rightSide}>
            ...
            isValidForm ? (
              <div className={css.textResult}>
                ...
                <br />
                <p>Враховано коефіцієнт: x{koefVaseSquare}</p>
        ...
        {/*                                   --------------------------   Блок для ввода количества ваз */}
        <div className={css.sheet}>
          <div className={css.leftSide}>
            <p>Вкажіть кількість ваз:</p>
            <TextField
              id="quantity"
              label="Кількість"
              variant="standard"
          ...
          <Accordion style={{ marginBottom: "10px" }}>
            ...
            <AccordionDetails>
              {costMaterial && isValidForm ? (
                <div>
                  <p className={css.textCost}>
                    Матеріал для однієї квадратної вази: {" "}
                    {Number(costMaterial.toFixed(2)).toLocaleString("ru-RU")}{" "}
                    грн.
                  </p>
                  <p>Кількість ваз: {quantity} шт.</p>
                </div>
              ) : (
                <p> </p>
              )}

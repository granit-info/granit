...
import css from "./CalcColumn.module.css";
...
export default function CalcColumn() {

  const koefColumn = 1.8;
  ...
  const [quantity, setQuantity] = useSyncedState<number>("ColumnQuantity", 1);
          ...
          <div className={css.rightSide}>
            ...
            isValidForm ? (
              <div className={css.textResult}>
                ...
                <br />
                <p>Враховано коефіцієнт: x{koefColumn}</p>
          ...
          <Accordion style={{ marginBottom: "10px" }}>
            ...
            <AccordionDetails>
              {costMaterial && isValidForm ? (
                <div>
                  <p className={css.textCost}>
                    Матеріал для однієї колони: {" "}
                    {Number(costMaterial.toFixed(2)).toLocaleString("ru-RU")}{" "}
                    грн.
                  </p>
                  <p>Кількість колон: {quantity} шт.</p>
                </div>
              ) : (
                <p> </p>
              )}

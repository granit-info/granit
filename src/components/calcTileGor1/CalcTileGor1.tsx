...
import css from "./calcTileGor1.module.css";
...
export default function CalcTileGor1() {
  ...
  useEffect(() => {
    const checkForm = () => {
      ...
      if (isValid && !facetLenghtTileGor1) {
        setFacetLenghtTileGor1(
  ...
  useEffect(() => {
    ...
    if (
      kopirTileGor1.lenght &&
      priseKopir.prise &&
      priseKopir.polishedKoef &&
      formData.thickness
    ) {
      calculatedCost =
        kopirTileGor1.lenght * formData.thickness * priseKopir.prise;
      calculatedCost *= kopirTileGor1.isPolished ? priseKopir.polishedKoef : 1;
    }

    setCostKopir(calculatedCost);
  }, [
    formData.thickness,
    kopirTileGor1.isPolished,
    kopirTileGor1.lenght,
    priseKopir.polishedKoef,
    priseKopir.prise,
  ]);
  ...
  useEffect(() => {
    ...
    switch (facetSizeTileGor1) {
      case 1:
        calculatedCostFacet = facetLenghtTileGor1! * priseFacet.first!;
        break;
      case 2:
        calculatedCostFacet = facetLenghtTileGor1! * priseFacet.second!;
        break;
      case 3:
        calculatedCostFacet = facetLenghtTileGor1! * priseFacet.third!;
        break;
      default:
  ...
  }, [formData, facetSizeTileGor1, priseFacet, facetLenghtTileGor1]);

...
import css from "./CalcSphere.module.css";
...
export default function CalcSphere() {

  const koefSphere = 1.8;
  ...
  const [quantity, setQuantity] = useSyncedState<number>("SphereQuantity", 1);
          ...
          <div className={css.rightSide}>
            ...
            isValidForm ? (
              <div className={css.textResult}>
                ...
                <br />
                <p>Враховано коефіцієнт: x{koefSphere}</p>
          ...
          <Accordion style={{ marginBottom: "10px" }}>
            ...
            <AccordionDetails>
              {costMaterial && isValidForm ? (
                <div>
                  <p className={css.textCost}>
                    Матеріал для одного шару: {" "}
                    {Number(costMaterial.toFixed(2)).toLocaleString("ru-RU")}{" "}
                    грн.
                  </p>
                  <p>Кількість шарів: {quantity} шт.</p>
                </div>
              ) : (
                <p> </p>
              )}
